...
if pygame.get_init():
    ...
    while running:
        ...
        # Clear local variables from memory for the next frame
        del CURRENT_WEATHER_CLASS;
        del CURRENT_HOUR;
        del CURRENT_MINUTE;
        del CURRENT_MONTH;
        del CURRENT_DAY;
        del CURRENT_DAY_OF_WEEK;
        del CURRENT_WEATHER_CODE;
        del CURRENT_TEMPERATURE;
        del CURRENT_LOCALE;

        del temp_cur_weather_bg;
        del background_image;
        del rounded_image;
        del current_weather_icon;
        del temp_fahren;
        del temp_text;
        del temp_text_fah;
        del temp_locale;
        del temp_current_day, temp_current_month;
        del current_date;
        del current_weather_pretext;
        del text_hour;
        del format_hour;
        del format_minute;
        del time_of_day_img;
